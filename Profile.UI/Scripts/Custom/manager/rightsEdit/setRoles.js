function setRoles(container) {
    ...
    function saveData() {
        ...
        $(container + " #saveRole:not(.disabled)").on("click", function () {
            ...
            sendData("/Manager/SetRoles/", JSON.stringify(traineeRoles), function (d) {  // URL - url for saving trainees roles and spec
    ...
    function deleteData() {
        ...
        $(container + " #deleteTrainee #saveDeleting:not(.disabled)").on("click", function () {
            ...
            var self = this;
            var usersIds = checkTrainees("value");
            var data = {};
            data.Users = usersIds; // array of trainees ID
            $(this).addClass("disabled");
            ...
            sendData("/Manager/DeleteUsers", data, function (d) { // URL - link for deleting post

                sendCallback("#deleteTrainee", usersIds);
                $(self).removeClass("disabled");
            });
